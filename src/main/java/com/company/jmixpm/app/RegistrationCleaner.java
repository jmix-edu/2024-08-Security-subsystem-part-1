...
public class RegistrationCleaner implements Job {
    ...
    public RegistrationCleaner(DataManager dataManager,
                               ...
                               DateTimeTransformations dateTimeTransformations, SystemAuthenticator authenticator) {
    ...
    private String deleteOldNotActivatedUsers() {
    ...
    public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        String result = authenticator.withSystem(this::deleteOldNotActivatedUsers);
